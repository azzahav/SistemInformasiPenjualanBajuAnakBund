...
$result = mysqli_query($mysqli, "SELECT * FROM produk ORDER BY id_produk ASC");
?>
...
<header>
  ...
  <tbody>
    ...
    $query = $_POST['query'];
    if($query != ''){
        $result = mysqli_query($mysqli, "SELECT * FROM produk WHERE id_produk LIKE '".$query."' ");
    ...
    while($user_data = mysqli_fetch_array($result)) {         
        ...
        echo "<td><a  href='editproduk.php?id_produk=$user_data[id_produk]'>Edit</a> | <a href='deleteproduk.php?id_produk=$user_data[id_produk]'>Delete</a></td></tr>";        
    }
    }
    else {
